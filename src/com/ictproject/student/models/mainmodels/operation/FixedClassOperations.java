...
public class FixedClassOperations extends Operations<FixedClass> {
    private static FixedClassOperations instance = new FixedClassOperations();

    public static FixedClassOperations getInstance() {
        return instance;
    }

    public FixedClassOperations() {
    }

    @Override
    public String converter(FixedClass element) {
        return element.getClassName();
    }

    public void initSomeClass() {
        FixedClass newClass = new FixedClass("Physic");
